			...
			<div class="row">
				<div class="col-md-4">
					...
					<form  method="post" action="${APP_PATH}/login.do" onsubmit="return checkForm()" class="fh5co-form animate-box" data-animate-effect="fadeInLeft">
						...
						<div class="form-group">
							<%--@declare id="remember"--%><label for="remember" class="sr-only">验证码</label>
							<input type="text" class="form-control" name="Captcha" maxlength="4" id="Captcha" placeholder="请输入验证码" type="Captcha" autocomplete="off">
							</label>
								<br>
